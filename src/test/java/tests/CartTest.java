...
public class CartTest extends BaseTest {
    ...
    public void testAddItemsToCart() {
        ...
        // Step 2 (Assignment adaptation): Clear the cart so only the in-stock laptop is validated.
        home.header().goToShoppingCart().clearCart();
        driver.get(configReader.getRequiredProperty("base.url"));

        // Step 3 (Assignment): Go to Laptops & Notebooks and add HP LP3065 to the cart.
        ...
        // Step 4 (Assignment): Open shopping cart and check the item details.
        ...
        // Step 5 (Assignment): Check that the total price is displayed.
